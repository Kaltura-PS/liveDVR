...
function WowzaStreamInfo(baseUrl, entryId, flavorParamsIds) {
...
WowzaStreamInfo.prototype.getFlavorUri = function(flavor) {
    var mediaServerBaseUrl = getFullLiveUrl(this._baseUrl, this.entryId, flavor);
    return url.resolve(mediaServerBaseUrl, persistenceFormat.getFlavorUriExtension());
};
